"""
Django settings for ergotopia project.
...
if "DEV" not in os.environ:
    ...
    CSRF_TRUSTED_ORIGINS = ['https://ergotopia.tw', 'http://ergotopia.tw']
else:
    ...
    if "TEST_NGROK_URL" in os.environ:
        ...
        ALLOWED_HOSTS = ["127.0.0.1", "localhost", TEST_NGROK_HOST] + LOCAL_TEST_HOST
        CSRF_TRUSTED_ORIGINS = [TEST_NGROK_URL,'https://ergotopia.tw', 'http://ergotopia.tw']
    else:
        ALLOWED_HOSTS = ["ergotopia.tw", "127.0.0.1", "localhost"] + LOCAL_TEST_HOST
        CSRF_TRUSTED_ORIGINS = ['https://ergotopia.tw', 'http://ergotopia.tw']
...
WSGI_APPLICATION = "ergotopia.wsgi.application"
